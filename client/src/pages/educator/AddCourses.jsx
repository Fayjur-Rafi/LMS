...
//             className="outline-none md:py-2.5 py-2 px-3 rounded-2xl border border-gray-500"
//             required
//           />
//         </div>
//         <div className="flex flex-col gap-1">
...
//                   </div>
//                 ))}
//                 <div className='inline-flex bg-gray-100 p-2 rounded-2xl cursor-pointer mt-2'>+ Add Lecture</div>
//                 </div>
//               )}
//             ))} */}
//           {chapters.map((chapter, chapterIndex) => (
...
//                   ))}
//                   <div
//                     className="inline-flex bg-gray-100 p-2 rounded-2xl cursor-pointer mt-2"
...
//           <div
//             className="flex justify-center items-center bg-blue-100 p-2 rounded-2xl cursor-pointer"
...
//               <div className="bg-white text-gray-700 p-4 rounded-2xl relative w-full">
...
//                   <input
//                     type="text"
//                     className="mt-1 block w-full border rounded-2xl py-1 px-2"
...
//                 <button
//                   type="button"
//                   className="w-full bg-blue-400 text-white px-4 py-2 rounded-2xl"
//                   onClick={addLecture}
//                 >
//                   Add
//                 </button>
...
//         <button
//           type="submit"
//           className="bg-black text-white w-max py-2.5 px-8 rounded-2xl my-4 cursor-pointer"
//         >
//           ADD
//         </button>
//       </form>
        ...
        <div>
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
              <div className="bg-white text-gray-700 p-6 rounded-2xl relative w-full max-w-md mx-4">
                <img
                  onClick={() => setShowPopup(false)}
                  src={assets.cross_icon}
                ...
                <div className="mb-4">
                  ...
                  <input
                    type="text"
                    className="mt-1 block w-full border rounded-2xl py-2 px-3"
                    value={lectureDetails.lectureTitle}
                    onChange={(e) =>
                      setLectureDetails({
                        ...lectureDetails,
                ...
                <button
                  type="button"
                  className="w-full bg-blue-400 text-white px-4 py-2 rounded-2xl cursor-pointer"
                  onClick={addLecture}
                >
                  Add
                </button>
